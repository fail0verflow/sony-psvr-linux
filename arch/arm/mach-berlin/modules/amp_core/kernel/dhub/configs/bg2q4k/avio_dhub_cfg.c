...
DHUB_channel_config  AG_config[AG_NUM_OF_CHANNELS] = {
    ...
    { avioDhubChMap_ag_PDM_MIC_ch1, DHUB_BANK0_START_ADDR+1024*6, DHUB_BANK0_START_ADDR+1024*6+32, 32, (512-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1},
    ...
    // Bank1
    { avioDhubChMap_ag_PDM_MIC_ch2, DHUB_BANK1_START_ADDR, DHUB_BANK1_START_ADDR+32, 32, (8192-32), dHubChannel_CFG_MTU_128byte, 1, 0, 1},
    // Bank2
