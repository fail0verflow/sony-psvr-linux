...
DHUB_channel_config  VIP_config[VIP_NUM_OF_CHANNELS] = {
    ...
    { avioDhubChMap_vip_MIC1_4CH_W, VIP_DHUB_BANK2_START_ADDR+1024*5, VIP_DHUB_BANK2_START_ADDR+1024*5+32, 32, (1024-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1},
    { avioDhubChMap_vip_MIC2_4CH_W, VIP_DHUB_BANK2_START_ADDR+1024*6, VIP_DHUB_BANK2_START_ADDR+1024*6+32, 32, (1024-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1},
    { avioDhubChMap_vip_PDM2_W, VIP_DHUB_BANK2_START_ADDR+1024*7, VIP_DHUB_BANK2_START_ADDR+1024*7+32, 32, (1024-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1},
    //BANK3
    { avioDhubChMap_vip_DDD_W, VIP_DHUB_BANK3_START_ADDR, VIP_DHUB_BANK3_START_ADDR+32, 32, (1024*6-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1},
    { avioDhubChMap_vip_DDD_R, VIP_DHUB_BANK3_START_ADDR+1024*6, VIP_DHUB_BANK3_START_ADDR+1024*6+32, 32, (1024*6-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1},
};
