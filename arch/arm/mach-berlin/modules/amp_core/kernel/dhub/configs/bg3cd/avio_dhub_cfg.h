...
#else
#define VPP_NUM_OF_CHANNELS		(avioDhubChMap_vpp_HDMI_R+1)
#endif
...
//DHUB_BANK1_START_ADDR is replaced by VPP_DHUB_BANK1_START_ADDR in CD chip
//No more DHUB_BANK0_START_ADDR used
